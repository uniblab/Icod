...
namespace Icod {
	...
	/// <include file='..\doc\Icod.xml' path='types/type[@name="Icod.Triplet`1"]/member[@name=""]/*'/>
	[Icod.LgplLicense]
	[Icod.Author( "Timothy J. ``Flytrap'' Bruce" )]
	[Icod.ReportBugsTo( "mailto:uniblab@hotmail.com" )]
	public class Triplet<T> : Icod.Triplet<T, T, T> {

		/// <include file='..\doc\Icod.xml' path='types/type[@name="Icod.Triplet`1"]/member[@name="#ctor(`0,`1,`2)"]/*'/>
